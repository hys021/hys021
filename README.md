...
![JPA](https://img.shields.io/badge/Spring%20Data%20JPA-6DB33F?style=flat-square&logo=hibernate&logoColor=white)
...
### 👻 귀신 유형 테스트 — 토스 미니앱 7월 챌린지 "미니앱과 함께하는 여름" 출품작
...
- REST API를 설계할 때 **어떤 로직을 어느 쪽에 둘 것인가**를 기준으로 판단하는 연습
- 도메인 단위 패키지 구조와 계층 분리를 프로젝트마다 일관되게 적용해 보기
- 관계형 DB(MySQL)와 NoSQL(Firestore) 각각의 설계 트레이드오프 정리
